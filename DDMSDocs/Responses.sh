...
dsh -n GlobalResponse "${app_name}" Header 0

dsh -n Response "${app_name}" Homepage 0

dsh -n Response "${app_name}" GettingStarted 0

dsh -n GlobalResponse "${app_name}" Footer 0

dsh -n GlobalResponse "${app_name}" ClosingHtml 0
