...
dsh -n DynamicOutputComponent "${app_name}" ResponsesOverview HomepageContent 0 'ResponseOverview.php'
dsh -a "${app_name}" Homepage ResponsesOverview HomepageContent DynamicOutputComponent
